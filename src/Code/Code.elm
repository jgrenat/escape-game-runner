...
import Styles.Styles exposing (inputClasses, labelClasses, validateButtonClasses)
    ...
    form [ onSubmit CodeAttempt, classes [ mw7, center, pa4, ba, br2_ns, b__black_10, bg_green, mb3 ] ]
        [ fieldset [ classes [ cf, bn, ma0, pa0 ] ]
            ...
            , div
                ...
                , input [ classes [ border_box, f6, bn, f5_l, input_reset, fl, black_80, bg_white, pa3, lh_solid, w_100, w_75_m, w_80_l, br2_ns, br__left_ns ], id "machineId", value model.codeInput, onInput OnCodeChanged ] []
